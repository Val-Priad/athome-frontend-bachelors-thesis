...
export default function HomePageContent() {
  ...
  return (
    <main className="relative min-h-svh overflow-hidden bg-neutral-900 text-white">
      <Image
        src="/images/home-hero-light.webp"
        alt={t("heroImageAlt")}
        fill
        preload
        sizes="100vw"
      ...
      <div className="relative z-10 flex min-h-svh items-end">
        <div className="flex w-full flex-col gap-5 p-5 pt-28">
          <section className="max-w-3xl">
            ...
            <p className="mt-5 max-w-xl leading-7 font-light text-white/90">
              {t("description")}
            </p>
            ...
            <div className="mt-8 flex flex-wrap gap-3">
              <button
                type="button"
                className="bg-primary text-primary-foreground hover:bg-primary-muted rounded-md px-5 py-2 text-sm font-medium transition"
                onClick={() => router.push("/estates")}
              >
                {t("browseEstates")}
              </button>
              ...
              <button
                type="button"
                className="rounded-md border border-white/40 bg-white/10 px-5 py-2 text-sm font-medium backdrop-blur transition hover:bg-white/20"
