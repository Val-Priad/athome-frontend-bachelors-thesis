...
* Finish correct field error display when the user enters invalid data into input fields.
* Return clear validation messages when the user types an invalid email or password during registration.
* Add i18n for the registration page.
* Make sure input fields use browser validation attributes where useful:
